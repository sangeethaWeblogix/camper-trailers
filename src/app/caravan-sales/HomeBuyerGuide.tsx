          ...
          <div className="hbg-row">
            ...
            <div className="hbg-text-col">
              <h2 className="hbg-title">
                Camping Trailer Sales Australia: Buyers Guide
              </h2>
          ...
          <div className="hbg-why-cards-wrap">
            <div className="hbg-why-grid">
              ...
              <div className="hbg-why-card">
                ...
                <p className="hbg-why-card-desc">Thousands of new and used camping trailers from dealers and private sellers across Australia.</p>
              </div>
