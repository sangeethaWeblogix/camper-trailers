...
export default function HomeLocationSection() {
      ...
      <div className="container">
        ...
        <div className="hloc-header">
          <h2 className="hloc-title">
            Find Camping Trailer Listings by Popular Location
          </h2>
          <p className="hloc-subtitle">Browse camping trailers near you by major Australian cities.</p>
  ...
  <h2 className="hloc-title">
           Search Camping Trailer Listings Your Way
          </h2>
