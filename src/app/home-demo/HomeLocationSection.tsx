      ...
      <div className="container">
        ...
        <div className="hloc-header">
          <h2 className="hloc-title">
            Find Camping Trailers for Sale by <span className="hloc-title-accent">Popular Location</span>
          </h2>
          <p className="hloc-subtitle">Browse camping trailers for sale near you by major Australian cities.</p>
...
<div className="hloc-header">
  <h2 className="hloc-title">
           Search Camping Trailers for Sale <span className="hloc-title-accent">Your Way</span>
          </h2>
