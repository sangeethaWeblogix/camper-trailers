...
/**
 * Band count for all pages — product_exists_check live fetch,
 * which returns { success, exists, count }. Replaces both the old
 * pool_test (indexed) and exists-only (noindex) paths.
 */
