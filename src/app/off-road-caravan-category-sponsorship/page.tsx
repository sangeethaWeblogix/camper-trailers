...
export const metadata: Metadata = {
  title: 'Off-Road Camping Trailer Category Sponsorship | Dominate the Off-Road Market Australia-Wide',
  description:
    "Exclusive Off Road Camping Trailer Listing Page Sponsorship for off-road camping trailer advertisers. Limited to just 1 advertiser per month — maximum exposure, retargeting included, and 100% share of voice in the off-road camping trailer category.",
}
    ...
    <main>
        ...
        <div className="container py-5 px-lg-5">
          <div className="col-lg-8">
            <h1 className="display-4 font-black mb-3 text-uppercase tracking-tight">
              DOMINATE THE OFF-ROAD <br className="d-none d-md-block" /> CAMPING TRAILER MARKET
            </h1>
      ...
      <section className="py-5 features-overview" data-purpose="features-overview" style={{ background: '#f1f1f1' }}>
        <div className="container">
          <h2 className="h3 font-black text-center mb-5">WHY INVEST IN OFF-ROAD CAMPING TRAILER CATEGORY SPONSORSHIP?</h2>
          <div className="takeover_box">
            <div className="row g-0 max-width-6xl mx-auto">
              ...
              <div className="col-md-3 p-4 text-center border-end border-light feature-card" data-purpose="feature-card">
                ...
                <p>Be one of only two brands shown to highly interested off-road camping trailer buyers.</p>
              </div>
              ...
              <div className="col-md-3 p-4 text-center border-end border-light feature-card" data-purpose="feature-card">
                ...
                <p>Reach thousands of serious off-road camping trailer enthusiasts searching for their next model.</p>
              </div>
        ...
        <div className="container py-5">
          <div className="text-center mb-5">
            <h2 className="h3 font-black text-navy mb-2 text-uppercase">
              THE ULTIMATE OFF-ROAD CAMPING TRAILER MARKETING PACKAGE
            </h2>
              ...
              <div className="package-card d-flex shadow-card" data-purpose="package-item">
                ...
                <div>
                  ...
                  <p className="small fw-medium m-0 lh-base">
                    Your brand in the top-of page position for off-road camping trailers.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-5">
              <div className="package-card d-flex shadow-card" data-purpose="package-item">
                ...
                <div>
                  ...
                  <p className="small fw-medium m-0 lh-base">
                    Limited to just 2 advertisers per category. You get 100% share of voice in Off-Road Camping Trailers.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-5">
              <div className="package-card d-flex shadow-card" data-purpose="package-item">
                ...
                <div>
                  ...
                  <p className="small fw-medium m-0 lh-base">
                    We target users actively searching for off-road camping trailers.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center justify-content-center g-4">
            ...
            <div className="col-auto">
              <Link
                ...
                href="https://advertisers.campingtrailersforsale.com.au/ad-signup-off-road/"
              >
                Subscribe Now
              </Link>
            </div>
