                ...
                <div className="col-lg-12">
                  <div className="accordion-item border-bottom rounded-0">
                    <h3 className="accordion-header" id="heading1">
                      ...
                      >
                        Semi Off Road & Full Off Road Camping Trailers
                      </button>
                    </h3>
                    <div
                      id="collapse1"
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        <h4>
                          How does the Eclipse X camping trailer excel in handling
                        ...
                        <p>
                          ...
                          camping trailer includes a robust off-road chassis and
                        ...
                        <h4>
                          How does the Nomad 17′ camping trailer perform in off-road
                          conditions?
                        </h4>
                        <p>
                          The{" "}
                          ...
                          17′ camping trailer is designed with off-road features similar
                  ...
                  <div className="accordion-item border-bottom rounded-0">
                    <h3 className="accordion-header" id="heading2">
                      ...
                      >
                        Hybrid Off Road Camping Trailers
                      </button>
                    </h3>
                    <div
                      id="collapse2"
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          <b>
                            What makes X Series RV camping trailers ideal for off-road
                            adventures?
                          </b>
                        </p>
                        <p>
                          ...
                          camping trailers are built tough for Australia’s harshest
                        ...
                        <p>
                          ...
                          is a lightweight, compact camping trailer designed for singles
                        ...
                        <p>
                          X Series RV camping trailers are engineered to deliver premium
                        ...
                        <p>
                          ...
                          This 22ft hard roof hybrid camping trailer provides both
                  ...
                  <div className="accordion-item border-bottom rounded-0">
                    <h3 className="accordion-header" id="heading3">
                      ...
                      >
                        Extreme Off Road Camping Trailers
                      </button>
                    </h3>
                    <div
                      id="collapse3"
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        <h4>
                          ...
                          Camping Trailers’ extreme off-road models?
                        </h4>
                        <p>
