    ...
    return (
      <section className="hf-section">
        <div className="container">
          <h2 className="hf-title" style={{ marginBottom: "20px" }}>Featured Off Road Camping Trailer Listings</h2>
      ...
      <div className="container">
        ...
        <div className="hf-grid">
          {items.slice(0, 8).map((item, idx) => {
            ...
            const type = (item.categories?.[0] ?? "").replace(/-/g, " ").replace(/\b\w/g, c => c.toUpperCase()) + " Camping Trailer";
