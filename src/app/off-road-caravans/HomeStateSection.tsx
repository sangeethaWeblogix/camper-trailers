                        ...
                        <div className="sec_left">
                          ...
                          <div className="info">
                            <div className="quick_linkss">
                              <p>{item.display_text.replace("caravan listings", "off road camping trailer listings")}</p>
                              <a className="view_all" href={item.permalink.replace(/^\/listings/, "/listings/off-road-category")}>
                                View Off Road Camping Trailers in {meta.code}{" "}
