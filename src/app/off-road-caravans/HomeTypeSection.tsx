...
const TYPES = [
  {
    ...
    label: "Off Road Camping Trailers for Sale",
  ...
  },
  {
    ...
    label: "Luxury Camping Trailers for Sale",
  ...
  },
  {
    ...
    label: "Hybrid Camping Trailers for Sale",
  ...
  },
  {
    ...
    label: "Pop Top Camping Trailers for Sale",
  ...
  },
  {
    ...
    label: "Touring Camping Trailers for Sale",
  ...
  },
  {
    ...
    label: "Family Camping Trailers for Sale",
    ...
    <section className="htype-section">
      <div className="container">
        <div className="htype-header">
          <h2 className="htype-title">Browse Camping Trailers for Sale by Type</h2>
        </div>
