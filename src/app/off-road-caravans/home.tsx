...
const OR_FAQ = [
  { q: "What is an off road camping trailer?", a: "An off road camping trailer is a camping trailer built to handle rough, unsealed tracks and remote terrain. They typically feature heavy-duty chassis, independent suspension, reinforced bodywork, larger water and battery capacity, and off-road tyres to handle Australia's outback and bush conditions." },
  { q: "What is the difference between semi off road and full off road camping trailers?", a: "Semi off road camping trailers are built for light unsealed roads and easy bush tracks, with upgraded suspension and stronger construction. Full off road camping trailers are engineered for extreme terrain — think river crossings, rocky tracks and remote touring — with independent suspension, heavy-duty chassis and full off-grid capability." },
  { q: "Can off road camping trailers go off grid?", a: "Yes. Most off road camping trailers come with or can be fitted with solar panels, lithium batteries, large fresh water tanks and composting or cassette toilets, allowing extended stays in remote areas without external power or water hookups." },
  { q: "Do I need a special vehicle to tow an off road camping trailer?", a: "Yes. Off road camping trailers are heavier and wider than standard camping trailers. You'll need a high-capacity 4WD with a tow bar rated to the camping trailer's ATM. Always check the camping trailer's ATM and the tow vehicle's GVM and tow rating before purchasing." },
  { q: "Are off road camping trailers suitable for families?", a: "Absolutely. Many off road models come in family-friendly layouts with bunk beds, multiple sleeping berths, full kitchens and ensuites. Brands like Jayco, New Age and Trakmaster offer popular family off road models across a range of budgets." },
  { q: "What is the average price of an off road camping trailer in Australia?", a: "Off road camping trailer prices in Australia typically range from around $40,000 for entry-level semi off road models to over $150,000 for premium full off road expedition camping trailers. The most popular mid-range models sit between $60,000 and $100,000." },
];
...
const SEARCH_FILTERS = [
  {
    ...
    links: [
      ...
      { text: "New Off Road Camping Trailers", href: "/listings/?condition=new&category=off-road" },
    ],
  },
  {
    label: "By Weight (ATM)",
...
export default function OffRoadCaravansPage({ stateBands, offRoadBlogs, offRoadPopularBlogs, offRoadBrandBlogs, offRoadModelBlogs, offRoadCount, offRoadPriceMin, offRoadPriceMax, offRoadUsedPriceMin, offRoadUsedPriceMax }: Props) {
  ...
  return (
    <div style={{ overflowX: "hidden" }}>
      ...
      <section className="hd-banner">
        <div className="container">
          <h1 className="hd-banner__title">
            Off Road Camping Trailers <span className="hd-banner__title--orange">Australia</span>
          </h1>
          ...
          <p className="hd-banner__subtitle">
            Discover Australia’s largest collection of off road camping trailers. Compare full off road, semi off road and hybrid camping trailers, browse live listings, read expert reviews and explore detailed buying guides to find the right camping trailer for your next adventure.
          </p>
          <div className="hd-banner__trust">
            <div className="hd-banner__trust-item">
              ...
              <div className="hd-banner__trust-text">
                ...
                <span>New &amp; used off road camping trailers across Australia</span>
              </div>
            </div>
            <div className="hd-banner__trust-item">
              <div className="hd-banner__trust-icon-wrap">
              ...
              <div className="hd-banner__trust-text">
                ...
                <span>Find off road camping trailers from every state &amp; territory</span>
              </div>
            </div>
            <div className="hd-banner__trust-item">
              <div className="hd-banner__trust-icon-wrap">
          ...
          <a href="/listings/off-road-category/" className="hd-banner__cta">
            ...
            Explore Off Road Camping Trailers
          </a>
      ...
      {/* ── Browse by State ── */}
      <HomeStateSection stateBands={stateBands} title="Browse Off Road Camping Trailers by State" />
      ...
      <section className="or-snapshot">
        <div className="container">
          <div className="or-snapshot__card">
            <h2 className="or-snapshot__title">Off Road Camping Trailer Market Snapshot</h2>
            <div className="or-snapshot__row">
              <div className="or-snapshot__item">
                ...
                <div className="or-snapshot__label">Off Road Camping Trailers<br />For Sale Now</div>
              </div>
              ...
              <div className="or-snapshot__item">
                ...
                <div className="or-snapshot__label">Off Road Camping Trailer<br />Price Range</div>
              </div>
              <div className="or-snapshot__divider" />
              <div className="or-snapshot__item">
      ...
      {/* ── Latest Off Road Camping Trailer Articles ── */}
      {offRoadBlogs.length > 0 && (
        <section className="or-latest-section">
          <div className="container">
            <h2 className="or-section-title">Latest Off Road Camping Trailer Articles</h2>
        ...
        <div className="container">
          <div className="or-cta-inner or-cta-inner--sell">
            <div className="or-cta-sell-left">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#0066cc" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>
              </svg>
              <div>
                <strong className="or-cta-sell-title">Looking to Sell Your Off Road Camping Trailer?</strong>
                <span className="or-cta-sell-sub">Reach thousands of serious buyers across Australia.</span>
              </div>
            </div>
            <a href="/sell-my-camper-trailer/" className="or-btn or-btn--outline">Sell My Camping Trailer</a>
          </div>
        </div>
      </section>
