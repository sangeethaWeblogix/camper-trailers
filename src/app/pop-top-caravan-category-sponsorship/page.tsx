      ...
      <header className="hero-bg text-white d-flex flex-column">
        <div className="container py-5 px-lg-5">
          <div className="col-lg-8">
            ...
            <div className="mb-4">
              <Link className="btn btn-caravan-orange px-5 py-3 fs-5" href="https://advertisers.caravansforsale.com.au/ad-signup-pop-top/">
                Claim Your Spot
              </Link>
            </div>
          ...
          <div className="row align-items-center justify-content-center g-4">
            ...
            <div className="col-auto">
              <Link
                ...
                href="https://advertisers.caravansforsale.com.au/ad-signup-pop-top/"
              >
                Subscribe Now
              </Link>
            </div>
