      ...
      <div className="post_bgs">
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            >
              <h3>Recent Camping Trailer Requests</h3>
              <p className="sub-text">
                See examples of what other camping trailer buyers are looking for.
              </p>
