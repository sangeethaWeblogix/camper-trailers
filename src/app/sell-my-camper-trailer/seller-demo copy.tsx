...
const CITY_LINKS = [
  { label: "Sell My Camping Trailer Melbourne", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Sydney", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Brisbane", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Perth", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Adelaide", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Gold Coast", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Sunshine Coast", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Newcastle", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Canberra", href: "/sell-my-camper-trailer/" },
  { label: "Sell My Camping Trailer Hobart", href: "/sell-my-camper-trailer/" },
];
