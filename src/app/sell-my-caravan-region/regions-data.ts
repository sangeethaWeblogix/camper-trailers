...
export function buildRegionMetadata(region: RegionInfo): Metadata {
  return {
    title: `Sell My Camping Trailer in ${region.label} | List Until Sold for $49`,
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: `Check similar camping trailers for sale in ${region.label} before setting your price. Compare by make, model, year, condition, length, ATM, tare weight, sleeping capacity, features and location. A realistic asking price can help attract more genuine buyers.`,
            },
          },
          {
            "@type": "Question",
